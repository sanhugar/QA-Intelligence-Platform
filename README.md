...
- **WP-1.1–WP-3.2 complete** — Stable Development Baseline **v3.2** released (`@ati/classification`). **WP-3.3 Repository Closed** — Feature Version & Lineage (`@ati/feature-version`); ready for Release Baseline v3.3.
- **Identity:** WP-2.5 = Requirement Intelligence Engine Foundation · WP-3.1 = Intake Entry Workflow · WP-3.2 = Classification & Designation · WP-3.3 = Feature Version & Lineage ([Identity Decision](docs/implementation/WP_IDENTITY_ARCHITECTURE_DECISION.md)).
...
- WP-3.2: [Release Baseline v3.2](docs/releases/RELEASE_BASELINE_v3.2.md) · [Implementation Report](docs/implementation/WP-3.2_IMPLEMENTATION_REPORT.md) · [Deferred](docs/implementation/WP-3.2_DEFERRED_CAPABILITY_REGISTER.md) · [`@ati/classification`](packages/classification/README.md)
- WP-3.3: [Git Readiness](docs/implementation/WP-3.3_GIT_READINESS_REVIEW.md) · [Closeout](docs/implementation/WP-3.3_REPOSITORY_CLOSEOUT.md) · [Independent Review](docs/implementation/WP-3.3_INDEPENDENT_ARCHITECTURE_REVIEW.md) · [Self Review](docs/implementation/WP-3.3_SELF_REVIEW.md) · [Implementation Report](docs/implementation/WP-3.3_IMPLEMENTATION_REPORT.md) · [Deferred](docs/implementation/WP-3.3_DEFERRED_CAPABILITY_REGISTER.md) · [`@ati/feature-version`](packages/feature-version/README.md)
